...
def make_flow_model(event_shape: Sequence[int],
    ...
    while layer_index < num_layers:
        ...
        random_mask = jax.random.randint(jax.random.PRNGKey(layer_index), event_shape, minval=0, maxval=2).astype(bool)
...
def get_config(dataset_name : str) -> config_dict.ConfigDict:
    ...
    config.model_name = "random_mask_uniform" + dataset_name
