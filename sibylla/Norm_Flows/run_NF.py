...
if __name__ == "__main__":
    ...
    flow_dict["multiscale"]["model"], flow_dict["multiscale"]["result"] = TrainerModule.train_flow(create_multiscale_flow(), checkpoint_path, model_name="MNISTFlow_multiscale")
    print("Done!")